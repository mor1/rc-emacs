(custom-set-variables
 ...
 '(package-selected-packages
    '(adaptive-wrap async auctex auto-compile auto-package-update balanced-windows
       company diminish direnv dockerfile-mode eldoc elisp-autofmt
       exec-path-from-shell fill-column-indicator filladapt git-ps1-mode
       hide-mode-line ido-completing-read+ just-mode magit markdown-mode mu4e
       nix-mode nix-modeline nixos-options ocaml-eglot org-gcal paradox
       rainbow-mode ruff-format solarized-theme tuareg typst-ts-mode unfill
       unkillable-scratch use-package uv-mode visual-fill-column vline
       web-server websocket xterm-color yasnippet))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit unspecified :extend unspecified :stipple unspecified :background unspecified :foreground unspecified :inverse-video unspecified :box unspecified :strike-through unspecified :overline unspecified :underline unspecified :slant normal :weight regular :height 90 :width normal :foundry "PfEd" :family "Atkinson Hyperlegible Mono"))))

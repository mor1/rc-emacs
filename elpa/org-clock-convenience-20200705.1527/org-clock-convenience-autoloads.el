...
Move cursor to the next agenda log line." t nil)

(autoload 'org-clock-convenience-backward-log-line "org-clock-convenience" "\
Move cursor to the previous agenda log line." t nil)
...
to the current position of point in the agenda log line." t nil)
...
the current agenda buffer." t nil)
...
from anywhere within a valid clocked time range line." t nil)
